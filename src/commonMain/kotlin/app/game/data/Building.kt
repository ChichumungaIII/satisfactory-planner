...
enum class Building(
  ...
  MINER_MK_1("Miner Mk. 1", Subcategory.MINERS, power = 5, {
    within(RecipeV2.Category.RESOURCE_EXTRACTION) {
      add(RecipeV2.IRON_ORE_IMPURE_MK_1)
      add(RecipeV2.IRON_ORE_NORMAL_MK_1)
      add(RecipeV2.IRON_ORE_PURE_MK_1)
      add(RecipeV2.COPPER_ORE_IMPURE_MK_1)
      add(RecipeV2.COPPER_ORE_NORMAL_MK_1)
      add(RecipeV2.COPPER_ORE_PURE_MK_1)
      add(RecipeV2.LIMESTONE_IMPURE_MK_1)
      add(RecipeV2.LIMESTONE_NORMAL_MK_1)
      add(RecipeV2.LIMESTONE_PURE_MK_1)
      add(RecipeV2.COAL_IMPURE_MK_1)
      add(RecipeV2.COAL_NORMAL_MK_1)
      add(RecipeV2.COAL_PURE_MK_1)
      add(RecipeV2.CATERIUM_ORE_IMPURE_MK_1)
      add(RecipeV2.CATERIUM_ORE_NORMAL_MK_1)
      add(RecipeV2.CATERIUM_ORE_PURE_MK_1)
      add(RecipeV2.RAW_QUARTZ_IMPURE_MK_1)
      add(RecipeV2.RAW_QUARTZ_NORMAL_MK_1)
      add(RecipeV2.RAW_QUARTZ_PURE_MK_1)
      add(RecipeV2.BAUXITE_IMPURE_MK_1)
      add(RecipeV2.BAUXITE_NORMAL_MK_1)
      add(RecipeV2.BAUXITE_PURE_MK_1)
      add(RecipeV2.SULFUR_IMPURE_MK_1)
      add(RecipeV2.SULFUR_NORMAL_MK_1)
      add(RecipeV2.SULFUR_PURE_MK_1)
      add(RecipeV2.URANIUM_IMPURE_MK_1)
      add(RecipeV2.URANIUM_NORMAL_MK_1)
      add(RecipeV2.URANIUM_PURE_MK_1)
      add(RecipeV2.SAM_IMPURE_MK_1)
      add(RecipeV2.SAM_NORMAL_MK_1)
      add(RecipeV2.SAM_PURE_MK_1)
    }
  }),
  MINER_MK_2("Miner Mk. 2", Subcategory.MINERS, power = 15, {
    within(RecipeV2.Category.RESOURCE_EXTRACTION) {
      add(RecipeV2.IRON_ORE_IMPURE_MK_2)
      add(RecipeV2.IRON_ORE_NORMAL_MK_2)
      add(RecipeV2.IRON_ORE_PURE_MK_2)
      add(RecipeV2.COPPER_ORE_IMPURE_MK_2)
      add(RecipeV2.COPPER_ORE_NORMAL_MK_2)
      add(RecipeV2.COPPER_ORE_PURE_MK_2)
      add(RecipeV2.LIMESTONE_IMPURE_MK_2)
      add(RecipeV2.LIMESTONE_NORMAL_MK_2)
      add(RecipeV2.LIMESTONE_PURE_MK_2)
      add(RecipeV2.COAL_IMPURE_MK_2)
      add(RecipeV2.COAL_NORMAL_MK_2)
      add(RecipeV2.COAL_PURE_MK_2)
      add(RecipeV2.CATERIUM_ORE_IMPURE_MK_2)
      add(RecipeV2.CATERIUM_ORE_NORMAL_MK_2)
      add(RecipeV2.CATERIUM_ORE_PURE_MK_2)
      add(RecipeV2.RAW_QUARTZ_IMPURE_MK_2)
      add(RecipeV2.RAW_QUARTZ_NORMAL_MK_2)
      add(RecipeV2.RAW_QUARTZ_PURE_MK_2)
      add(RecipeV2.BAUXITE_IMPURE_MK_2)
      add(RecipeV2.BAUXITE_NORMAL_MK_2)
      add(RecipeV2.BAUXITE_PURE_MK_2)
      add(RecipeV2.SULFUR_IMPURE_MK_2)
      add(RecipeV2.SULFUR_NORMAL_MK_2)
      add(RecipeV2.SULFUR_PURE_MK_2)
      add(RecipeV2.URANIUM_IMPURE_MK_2)
      add(RecipeV2.URANIUM_NORMAL_MK_2)
      add(RecipeV2.URANIUM_PURE_MK_2)
      add(RecipeV2.SAM_IMPURE_MK_2)
      add(RecipeV2.SAM_NORMAL_MK_2)
      add(RecipeV2.SAM_PURE_MK_2)
    }
  }),
  MINER_MK_3("Miner Mk. 3", Subcategory.MINERS, power = 45, {
    within(RecipeV2.Category.RESOURCE_EXTRACTION) {
      add(RecipeV2.IRON_ORE_IMPURE_MK_3)
      add(RecipeV2.IRON_ORE_NORMAL_MK_3)
      add(RecipeV2.IRON_ORE_PURE_MK_3)
      add(RecipeV2.COPPER_ORE_IMPURE_MK_3)
      add(RecipeV2.COPPER_ORE_NORMAL_MK_3)
      add(RecipeV2.COPPER_ORE_PURE_MK_3)
      add(RecipeV2.LIMESTONE_IMPURE_MK_3)
      add(RecipeV2.LIMESTONE_NORMAL_MK_3)
      add(RecipeV2.LIMESTONE_PURE_MK_3)
      add(RecipeV2.COAL_IMPURE_MK_3)
      add(RecipeV2.COAL_NORMAL_MK_3)
      add(RecipeV2.COAL_PURE_MK_3)
      add(RecipeV2.CATERIUM_ORE_IMPURE_MK_3)
      add(RecipeV2.CATERIUM_ORE_NORMAL_MK_3)
      add(RecipeV2.CATERIUM_ORE_PURE_MK_3)
      add(RecipeV2.RAW_QUARTZ_IMPURE_MK_3)
      add(RecipeV2.RAW_QUARTZ_NORMAL_MK_3)
      add(RecipeV2.RAW_QUARTZ_PURE_MK_3)
      add(RecipeV2.BAUXITE_IMPURE_MK_3)
      add(RecipeV2.BAUXITE_NORMAL_MK_3)
      add(RecipeV2.BAUXITE_PURE_MK_3)
      add(RecipeV2.SULFUR_IMPURE_MK_3)
      add(RecipeV2.SULFUR_NORMAL_MK_3)
      add(RecipeV2.SULFUR_PURE_MK_3)
      add(RecipeV2.URANIUM_IMPURE_MK_3)
      add(RecipeV2.URANIUM_NORMAL_MK_3)
      add(RecipeV2.URANIUM_PURE_MK_3)
      add(RecipeV2.SAM_IMPURE_MK_3)
      add(RecipeV2.SAM_NORMAL_MK_3)
      add(RecipeV2.SAM_PURE_MK_3)
    }
  }),
